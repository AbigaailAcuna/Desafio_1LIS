...
<div class="container">
    ...
    <div class="row">
        <div class="">
            ...
            <a href="../productos.php" class="btn btn-primary"></span> Regresar</a>
...
<div class="myDiv">
    <button style="background-color:lightblue;height:40px;width:90px" onclick="history.back()">Regresar</button>
</div>
